...
public class BeregnBarnebidragControllerIntegrationTest {
  ...
  private Integer forventetBarnebidragAntallGrunnlagReferanserBarn1;
  ...
  void skalKalleCoreOgReturnereEtResultat_Eksempel01() {
    ...
    forventetBarnebidragAntallGrunnlagReferanserBarn1 = 7;
...
//            .getResultatBelop()).isEqualTo(forventetSamvaersfradragBelopBarn1),
        ...
        () -> assertThat(totalBarnebidragResultat.getBeregnetBarnebidragPeriodeListe().get(0).getGrunnlagReferanseListe().size())
            .isEqualTo(forventetBarnebidragAntallGrunnlagReferanserBarn1)
    );
  }
